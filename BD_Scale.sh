...
ansible-playbook xconnect_scale.yml -e '{"FF_start_evi_ID":1001,"FF_end_evi_ID":1050,"H_QOS":"YES","Flat_QOS":"NO","CCM_REQUIRED":"n"}' --tags create_ELAN_service
...
ansible-playbook xconnect_scale.yml -e '{"FF_start_evi_ID":1001,"FF_end_evi_ID":1050,"H_QOS":"YES","Flat_QOS":"NO","CCM_REQUIRED":"n"}' --tags delete_ELAN_service
